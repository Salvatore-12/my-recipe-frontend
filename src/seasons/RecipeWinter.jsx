...
import { getRecipeWinter } from "../Redux/action";

const RecipeWinter = () => {
    const dispatch = useDispatch();
    const recipe = useSelector(state => state.recipeWinter); 
   

    useEffect(() => {
        dispatch(getRecipeWinter());
    }, [dispatch]);
    ...
    return( 
      ...
      <Container className="mt-4">
            ...
            <h1 className="text-center mb-4">Ricette Invernali:</h1>
